...
var (
	pattern_ProjectService_Summary_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"dropship", "api", "v1", "status"}, "", runtime.AssumeColonVerbOpt(true)))
